              ...
              {conversations?.map((conversation) => (
                <div key={uniqueId('conversation')}>
                  ...
                  >
                    ...
                    <div className="flex items-center flex-shrink-0 transition-all ease-in-out space-x-[-2.5rem] hover:-space-x-6 duration-250">
                      {conversation.contacts
                        .map((contact: Contact | string) => (
                          <div
                            className="flex items-center justify-center w-12 h-12 transition-colors duration-200 ease-in-out bg-gray-700 border-4 border-gray-900 rounded-full select-none group-hover:border-gray-800 group-focus:border-gray-800"
