...
const EdgeIcon = ({ className }: EdgeIconProps) => {
  return (
    <svg className={className} viewBox="0 0 256 256">
      <defs>
        <style>{`.cls-1{fill:url(#linear-gradient);}.cls-2{opacity:0.35;fill:url(#radial-gradient);}.cls-2,.cls-4{isolation:isolate;}.cls-3{fill:url(#linear-gradient-2);}.cls-4{opacity:0.41;fill:url(#radial-gradient-2);}.cls-5{fill:url(#radial-gradient-3);}.cls-6{fill:url(#radial-gradient-4);}`}</style>
        <linearGradient
          id="linear-gradient"
          x1="63.33"
          y1="84.03"
